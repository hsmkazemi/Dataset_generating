...
thigh_L.constraints["Limit Rotation"].min_y = math.radians(-20)
thigh_L.constraints["Limit Rotation"].max_y = math.radians(20)
...
thigh_R.constraints["Limit Rotation"].min_y = math.radians(-20)
thigh_R.constraints["Limit Rotation"].max_y = math.radians(20)
...
foot_L.constraints["Limit Rotation"].min_y = math.radians(-30)
foot_L.constraints["Limit Rotation"].max_y = math.radians(30)
...
foot_R.constraints["Limit Rotation"].min_y = math.radians(-30)
foot_R.constraints["Limit Rotation"].max_y = math.radians(30)
...
coord_file_path = "D:\\Codes\\Blender\\final_files\\standing_coordinates.txt"
...
for iteration in range(0,factor):
    decider = randint(1,3)
    if decider == 1:
        axis = 'X'
    if decider == 2:
    ...
    bpy.ops.transform.rotate(value=random(), orient_axis=axis)
